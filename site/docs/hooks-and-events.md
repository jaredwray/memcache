...
description: Observe and intercept Memcache operations with Hookified events and before/after hooks.
order: 3
---

The Memcache client extends [Hookified](https://hookified.org) to provide powerful hooks and events for monitoring and customizing behavior.
